				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.4s">
							<h2>Contact Info</h2>
							<ul>
								<li><i class="fa fa-home fa-2x"></i> Office 38, Malabe Sri Lanka</li>
								<hr>
								<li><i class="fa fa-phone fa-2x"></i>0712345678</li>
								<hr>
								<li><i class="fa fa-envelope fa-2x"></i> info@xyz.com</li>
							</ul>
						</div>
